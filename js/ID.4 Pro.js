...
$('.color_section>ul>li').eq(0).click(function(){
    ...
    $('.color_option>p').html('<span class="korean_text">스톤워시드 블루 메탈릭</span><input type="hidden" name="car_color" value="스톤워시드 블루 메탈릭" />');
...
$('.color_section>ul>li').eq(2).click(function(){
    ...
    $('.color_option>p').html('<span class="korean_text">킹스 레드 메탈릭</span><input type="hidden" name="car_color" value="킹스 레드 메탈릭" />');
...
$('.color_section>ul>li').eq(4).click(function(){
    ...
    $('.color_option>p').html('<span class="korean_text">스케일 실버 메탈릭</span><input type="hidden" name="car_color" value="스케일 실버 메탈릭" />');
...
$('.color_section>ul>li').eq(5).click(function(){
    ...
    $('.color_option>p').html('<span class="korean_text">블루 더스크 메탈릭</span><input type="hidden" name="car_color" value="블루 더스크 메탈릭" />');
...
$('.color_section>ul>li').eq(6).click(function(){
    ...
    $('.color_option>p').html('<span class="korean_text">문스톤 그레이</span><input type="hidden" name="car_color" value="문스톤 그레이" />');
...
$('.wheel_section>ul>li').click(function(){
    ...
    $('.wheel_option>p').html('<span class="korean_text">드람멘</span> <span class="special_text">9</span>J x <span class="special_text">20”</span><input type="hidden" name="car_wheel" value="드람멘 9J X 20 " />');
