...
$('.color_section>ul>li').eq(0).click(function(){
    ...
    $('.color_option>p').html('<span class="korean_text">퓨어 화이트</span><input type="hidden" name="car_color" value="퓨어 화이트" />');
...
$('.color_section>ul>li').eq(1).click(function(){
    ...
    $('.color_option>p').html('<span class="korean_text">타마린드 브라운 메탈릭</span><input type="hidden" name="car_color" value="타마린드 브라운 메탈릭" />');
...
$('.color_section>ul>li').eq(2).click(function(){
    ...
    $('.color_option>p').html('<span class="korean_text">세츄라 베이지 메탈릭</span><input type="hidden" name="car_color" value="세츄라 베이지 메탈릭" />');
...
$('.color_section>ul>li').eq(5).click(function(){
    ...
    $('.color_option>p').html('<span class="korean_text">멜로 블루 클리스탈 이펙트</span><input type="hidden" name="car_color" value="멜로 블루 클리스탈 이펙트" />');
...
$('.wheel_section>ul>li').click(function(){
    ...
    $('.wheel_option>p').html('<span class="korean_text">요크</span> <span class="special_text">9</span>J X <span class="special_text">20"</span><input type="hidden" name="car_wheel" value="요크 9J X 20"" />');
...
$('.seat_section>ul>li').eq(0).click(function(){
    ...
    $('.seat_option>p').html('<span class="korean_text">비에나 가죽 시트 베이지</span><input type="hidden" name="car_seat" value="비에나 가죽 시트 베이지"" />');
...
$('.seat_section>ul>li').eq(1).click(function(){
    ...
    $('.seat_option>p').html('<span class="korean_text">비에나 가죽 시트 소울 블랙</span><input type="hidden" name="car_seat" value="비에나 가죽 시트 소울 블랙"" />');
