...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %> 
    <link rel="stylesheet" href="<%= request.getContextPath() %>/css/deleteBoardPwd.css">
	<main>
<div style="margin-top: 50px;">
    <h2><span class="korean_text">글 삭제</span></h2>
</div>
    <div class="dm korean_text">
        <form action="boarddeletepassword.do" method="post">
