                ...
                <ul class="design cf">
                    <li>
                        ...
                        <div class="section trim_section">
                            ...
                            <ul>
                                <li class="no_mr no_mt"><img src="/resources/images/contents_id4/mainPro.png" alt="ID.4 Pro">&nbsp;ID<span class="special_text">.4</span> Pro</li>
            ...
            <section class="customization_option_section w1300">
                ...
                <ul class="customization_option">
                    <li class="trim_option">
                        <h3>Trim</h3><br><br>
                        <img src="/resources/images/contents_id4/mainPro.png" alt="">
                        <input type="hidden" name="car_name" value="ID.4 Pro" />
                        <p>ID<span class="special_text">.4</span> Pro</p>
                    </li>
                ...
                <div>
                    <h3><span class="korean_text">차량가격</span>&nbsp;&nbsp;<span class="special_text">64,900,000</span><span class="korean_text">원</span></h3>
                    <input type="hidden" value="64,900,000" name="car_price" />
...
<!-- pPage JS -->
<script src="/resources/js/ID.4 Pro.js"></script>
